  ...
  try {
    ...
    var dgeni = new Dgeni([require('../config/')
      .config(function (readFilesProcessor, writeFilesProcessor) {
        ...
        readFilesProcessor.sourceFiles = [{include: '../public/**/*.js', basePath: 'src'}, {include: 'docs/content/**/*.ngdoc',basePath: 'docs/content'}];
      ...
      .config(function (renderDocsProcessor) {
        ...
        renderDocsProcessor.extraData.git = {
          info: {
            owner: 'hospitalneuquen',
            repo: 'app-internacion'
          },
          version: {
            isSnapshot: true
          }
