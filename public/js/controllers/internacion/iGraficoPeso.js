angular.module('app').controller('internacion/iGraficoPeso', ['$scope', 'Plex', 'Shared', 'Server', 'Session', function($scope, Plex, Shared, Server, Session) {
    'use strict';
            ...
            if (internacion != null) {
                ...
                if ($scope.internacion.evoluciones.length) {
                    angular.forEach($scope.internacion.evoluciones, function(evolucion) {
                        if (typeof evolucion.signosVitales != "undefined" && typeof evolucion.signosVitales.peso != "undefined" && evolucion.signosVitales.peso > 0) {
                            ...
                            $scope.chart.options.series[0].data.push({
                                x: date,
                                y: evolucion.signosVitales.peso
                            });
                        }
                    });
