...
gulp.task('docs:serve', ['dgeni', 'docs:wiredep', 'module'], function () {
	browserSyncInit(['.tmp', 'app'], ['app/*.html', 'app/src/**/*', '../../public/**/*.js']);
	gulp.watch(['config/templates/**/*', 'content/**/*', '../src/{app,components}/**/*.js', '../../public/**/*.js'], ['dgeni', browserSync.reload]);
    gulp.watch(['../src/{app,components}/**/*.js'], ['module']);
	gulp.watch(['../../public/**/*.js'], ['module']);
});
